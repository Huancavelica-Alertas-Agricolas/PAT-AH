"use strict";
// Comentarios añadidos en español: resolver GraphQL para autenticación (register/login/recover/verify/reset).
// Cómo lo logra: expone mutations que delegan en `AuthService` y operaciones de verificación/registro con `PrismaService`.
