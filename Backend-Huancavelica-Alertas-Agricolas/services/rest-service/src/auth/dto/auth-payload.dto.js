"use strict";
// Comentarios añadidos en español: DTO `AuthPayload` (transpilado) que contiene el `token` y el `user`.
// Cómo lo logra: declara campos GraphQL y referencia `UserDto` para el campo `user`.
