"use strict";
// Comentarios añadidos en español: resolver GraphQL para `zones`.
// Cómo lo logra: expone `getZones` y `getZoneById` que usan `PrismaService` para consultar la tabla `zone`.
