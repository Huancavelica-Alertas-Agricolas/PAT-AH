...
import { CheckIcon, ChevronRightIcon, CircleIcon, ChevronDownIcon, PanelLeftIcon } from "lucide-react";

// NavigationMenu imports
...
import { Separator } from "./data-display";
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from "./overlay";
import { Skeleton } from "./data-display";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "./overlay";
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="sidebar-group" data-sidebar="group" className={cn("relative flex w/full min-w-0 flex-col p-2".replace("/","-"), className)} {...props} />;
}
...
function SidebarMenuButton({ asChild = false, isActive = false, variant = "default", size = "default", tooltip, className, ...props }: React.ComponentProps<"button"> & { asChild?: boolean; isActive?: boolean; tooltip?: string | React.ComponentProps<typeof TooltipContent> } & VariantProps<typeof sidebarMenuButtonVariants>) {
  ...
  if (typeof tooltip === "string") {
    tooltip = { children: tooltip } as React.ComponentProps<typeof TooltipContent>;
  }
  return (
    <Tooltip>
      <TooltipTrigger asChild>{button}</TooltipTrigger>
      <TooltipContent side="right" align="center" hidden={state !== "collapsed" || isMobile} {...(tooltip as React.ComponentProps<typeof TooltipContent>)} />
    </Tooltip>
  );
}
